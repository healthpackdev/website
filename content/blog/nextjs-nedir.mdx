...
# image: nextjs-nedir-image.png
description: Next.js'in ne olduğu, ne için kullanıldığı ve nasıl kullanıldığını anlatacağız.
publishedAt: 1625057339160
---
...
<Image alt={`Next.js and Prisma`} src={`/static/images/next-prisma/prisma.gif`} width={830} height={489} />
...
<Image alt={`Prisma Flow`} src={`/static/images/next-prisma/prisma-flow.png`} width={1600} height={842} />
...
<Image alt={`Prisma Studio`} src={`/static/images/next-prisma/studio.gif`} width={983} height={537} />
